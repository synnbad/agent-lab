# Grill-Me Sinbad Skill Tests

## Agent Being Tested
Grill-Me Sinbad Skill
...
## Input Prompt
Use Grill-Me Sinbad Skill on this sanitized scenario. Identify the goal, missing information, risks, recommendations, and next steps without inventing facts.
