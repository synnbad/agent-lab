# Library Assessment Specialist Agent Tests
...
## Input Prompt
Use Library Assessment Specialist Agent on this sanitized scenario. Identify the goal, missing information, risks, recommendations, and next steps without inventing facts.
