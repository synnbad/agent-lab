...
## Input Prompt
Use Accessibility Agent on this sanitized scenario. Identify the goal, missing information, risks, recommendations, and next steps without inventing facts.
