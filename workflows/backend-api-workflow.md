...
## Purpose
Design API behavior, data flow, validation, and operational checks.

## Trigger
Use when planning backend services or integrations.
...
1. Define consumers, resources, and permissions
2. Specify endpoints, validation, errors, and logging
3. Review data sensitivity and auth
